...
def download_scripts(destination_folder):
    ...
    saved_scripts = [download_individual_script(script["id"], script_dir) for script in scripts_metadata]
...
def manager(arguments):
    ...
    parser.add_argument("--no-attachement", action="store_true")
    ...
    if arguments and arguments[0] == "help":
        ...
        download_scripts(options.dest_dir)
